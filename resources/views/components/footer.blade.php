    ...
    <div class="footer-area footer-height pt-40 pb-30">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 offset-xl-1 col-lg-6 col-md-6 pr-0 mb-40">
                    <div class="footer-widget footer-link">
                        <h3>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Liens rapides</font>
                            </font>
                        </h3>
                        <ul>
...
<!-- JS here -->
<script src="{{ asset('js/modernizr-3.8.0.min.js') }}"></script>
