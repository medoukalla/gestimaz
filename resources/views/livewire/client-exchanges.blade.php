<div class="row">
    ...
    <div class="modal fade @if( $changed == true ) show @endif" tabindex="-1" id="exchange_model">
                                        ...
                                        <div class="d-flex align-items-center mb-6">
                                            ...
                                            <div class="alert alert-dismissible bg-light-primary border border-primary d-flex flex-column flex-sm-row p-5 mb-10 w-100">
                                                ...
                                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                                    ...
                                                    <span>Cet échange est en attente de confirmation ( <b>Acceptation</b> ou <b>Annulation</b> )</span>
                                                </div>
                                            </div>
                                        </div>
