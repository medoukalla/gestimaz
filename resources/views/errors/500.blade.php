        ...
        <div class="card card-flush w-lg-650px py-5">
            <div class="card-body py-15 py-lg-20">
                ...
                <div class="fw-semibold fs-6 text-gray-500 mb-7">
                    Oh non ! Une erreur interne du serveur s'est produite. Veuillez nous excuser pour ce désagrément. Notre équipe technique a été notifiée et travaille à résoudre le problème.
                </div>
                <!--end::Text-->

                <!--begin::Illustration-->
                <div class="mb-11">
                    <img src="{{ asset('img/errors/500.png') }}"
